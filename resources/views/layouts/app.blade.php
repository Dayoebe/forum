...
<head>
    ...
    <meta name="author" content="Adedayo Oyetoke">
...
<footer class="w-full border-t bg-white pb-12">
    <div class="w-full container mx-auto flex flex-col inline items-center">
        <div class="uppercase py-6">&copy; wirelesscs.com - 
