<article class="bg-white flex flex-col shadow my-4 hover:bg-blue-100 hover:border">
    ...
    <div class="bg-white flex flex-col justify-start p-6">
        ...
        @if ($showAuthor)
            <p href="{{ route('profile', $post->user->id) }}" class="text-sm pb-3">
                By <a href="{{ route('profile', $post->user->id) }}" class="font-semibold hover:text-gray-800">{{$post->user->name}}</a>, Published on
